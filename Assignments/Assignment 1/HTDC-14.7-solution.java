...
interface IGroceryItem {
    // Calculate the unit price (cents per gram) of an item
    // int unitPrice() {
    //   ... this.weight
    //   ... this.price
    // }
    ...
    // Return true if this item's unit price is less than the given aount
    // boolean lowerUnitPrice(double amount) {
    //   ... this.unitPrice()
    // }
    boolean lowerUnitPrice(double amount);

    // Return true if this item's unit price is less than given item's unit price
